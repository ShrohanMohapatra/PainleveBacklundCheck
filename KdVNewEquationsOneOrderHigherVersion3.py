...
# Reconciliation part of the program

QKdV_1_plus = expand(Equation2Storage/(24*sigma*diff(phi, x)))
QKdV_2_plus = expand(Equation3_compatibility_test/(12*sigma))
assert expand((Equation4_compatibility_test)/12/sigma - diff(u2*diff(phi,x,x)-u3*diff(phi,x)**2+diff(phi,x,t)+sigma*diff(phi,x,x,x,x),x)) == 0
QKdV_3_plus = u2*diff(phi,x,x)-u3*diff(phi,x)**2+diff(phi,x,t)+sigma*diff(phi,x,x,x,x)
QKdV_4_plus = expand(Equation5_compatibility_test)
QKdV_5_plus = expand(Equation6_compatibility_test)
QKdV_6_plus = expand(Equation7_compatibility_test/u3)

print('--------------------------------------------------------------------------')
print('QKdV_1_plus = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(QKdV_1_plus), '= 0')
print('--------------------------------------------------------------------------')

print('--------------------------------------------------------------------------')
print('QKdV_2_plus = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(QKdV_2_plus), '= 0')
print('--------------------------------------------------------------------------')

print('--------------------------------------------------------------------------')
print('QKdV_3_plus = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(QKdV_3_plus), '= 0')
print('--------------------------------------------------------------------------')

print('--------------------------------------------------------------------------')
print('QKdV_4_plus = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(QKdV_4_plus), '= 0')
print('--------------------------------------------------------------------------')

print('--------------------------------------------------------------------------')
print('QKdV_5_plus = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(QKdV_5_plus), '= 0')
print('--------------------------------------------------------------------------')

print('--------------------------------------------------------------------------')
print('QKdV_6_plus = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(QKdV_6_plus), '= 0')
print('--------------------------------------------------------------------------')


print('--------------------------------------------------------------------------')
print('diff(QKdV_1_plus,t)-diff(phi,x)**2*QKdV_4_plus = ')
print('--------------------------------------------------------------------------')
print(expand(diff(QKdV_1_plus,t)-diff(phi,x)**2*QKdV_4_plus), ' = 0')
print('--------------------------------------------------------------------------')
print(showDiffNotation(expand(diff(QKdV_1_plus,t)-diff(phi,x)**2*QKdV_4_plus)), '= 0')
print('--------------------------------------------------------------------------')

print('--------------------------------------------------------------------------')
print('diff(QKdV_2_plus,t)-diff(phi,x)**4*QKdV_5_plus = ')
print('--------------------------------------------------------------------------')
print(expand(diff(QKdV_2_plus,t)-diff(phi,x)**4*QKdV_5_plus), ' = 0')
print('--------------------------------------------------------------------------')
print(showDiffNotation(expand(diff(QKdV_2_plus,t)-diff(phi,x)**4*QKdV_5_plus)), '= 0')
print('--------------------------------------------------------------------------')

u3x_extractor = expand((diff(QKdV_1_plus,t)-diff(phi,x)**2*QKdV_4_plus))*(- sigma*Derivative(phi, x)**2*Derivative(phi, t, (x, 4)) + 4*sigma*Derivative(phi, x)*Derivative(phi, (x, 2))*Derivative(phi, t, (x, 3)) + 4*sigma*Derivative(phi, x)*Derivative(phi, (x, 3))*Derivative(phi, t, (x, 2)) - 2*sigma*Derivative(phi, x)*Derivative(phi, (x, 4))*Derivative(phi, t, x) - 9*sigma*Derivative(phi, (x, 2))**2*Derivative(phi, t, (x, 2)) + 4*sigma*Derivative(phi, (x, 2))*Derivative(phi, (x, 3))*Derivative(phi, t, x) - u3**2*Derivative(phi, x)**5 - u3*Derivative(phi, x)**4*Derivative(u2, x) + 4*u3*Derivative(phi, x)**3*Derivative(phi, t, x) + Derivative(phi, t)*Derivative(phi, x)*Derivative(phi, t, (x, 2)) + Derivative(phi, t)*Derivative(phi, (x, 2))*Derivative(phi, t, x) + Derivative(phi, (t, 2))*Derivative(phi, x)*Derivative(phi, (x, 2)) - Derivative(phi, x)**2*Derivative(phi, (t, 2), x) - 2*Derivative(phi, x)*Derivative(phi, t, x)**2)-(diff(QKdV_2_plus,t)-diff(phi,x)**4*QKdV_5_plus)*(-12*sigma*u3*Derivative(phi, x)**2*Derivative(phi, (x, 3)) - sigma*Derivative(phi, x)**2*Derivative(u2, (x, 3)) + 4*sigma*Derivative(phi, x)*Derivative(phi, t, (x, 3)) - 6*sigma*Derivative(phi, (x, 2))*Derivative(phi, t, (x, 2)) + 4*sigma*Derivative(phi, (x, 3))*Derivative(phi, t, x) - u2*Derivative(phi, x)**2*Derivative(u2, x) + 2*u2*Derivative(phi, x)*Derivative(phi, t, x) + Derivative(phi, t)*Derivative(phi, t, x) + Derivative(phi, (t, 2))*Derivative(phi, x))
u3x_extractor = expand(u3x_extractor)
# u3x_extractor = collect(collect(collect(u3x_extractor, diff(u3,x)),diff(u3,x,x)),diff(u3,x,x,x))
print('--------------------------------------------------------------------------')
print('u3x_extractor = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(expand(u3x_extractor)), '= 0')
print('--------------------------------------------------------------------------')
print('coeff(u3x_extractor, diff(u3,(x,3))) = ', showDiffNotation(u3x_extractor.coeff(diff(u3,(x,3)), 1)))
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
print('coeff(u3x_extractor, diff(u3,(x,2))) = ', showDiffNotation(u3x_extractor.coeff(diff(u3,(x,2)), 1)))
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
print('coeff(u3x_extractor, diff(u3,x)) = ', showDiffNotation(u3x_extractor.coeff(diff(u3,x), 1)))
print('--------------------------------------------------------------------------')

diffQKdV_1_plus_x = diff(QKdV_1_plus, x)
print('--------------------------------------------------------------------------')
print('diff(QKdV_1_plus, x)')
print('--------------------------------------------------------------------------')
print(showDiffNotation(diffQKdV_1_plus_x), ' = 0')
print('--------------------------------------------------------------------------')
...
A1 = 2
A2 = -diff(phi,x)**2
B1 = diffQKdV_1_plus_x-A1*(u2*diff(phi,x,x)+sigma*diff(phi,(x,4)))
B2 = QKdV_2_plus-A2*(-u3*diff(phi,x)**2+diff(phi,x,t))

print('--------------------------------------------------------------------------')
print('(A2*diff(QKdV_1_plus, x)+A1*QKdV_2_plus-A2*B1-A1*B2)/(A1*A2) = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(expand((A2*diffQKdV_1_plus_x+A1*QKdV_2_plus-A2*B1-A1*B2)/(A1*A2))))
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
print('(A2*diff(QKdV_1_plus, x)+A1*QKdV_2_plus-A2*B1-A1*B2)-(A1*A2)*QKdV_3_plus = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(expand((A2*diffQKdV_1_plus_x+A1*QKdV_2_plus-A2*B1-A1*B2)-A1*A2*QKdV_3_plus)))
print('--------------------------------------------------------------------------')
print('A2*B1 + A1*B2 = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(expand((A2*B1+A1*B2))))
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
print('2*QKdV_2_plus-phi_x^2*diff(QKdV_1_plus, x)+2*phi_x^2*QKdV_3_plus')
print('--------------------------------------------------------------------------')
print(expand(2*QKdV_2_plus-diff(phi, x)**2*diff(QKdV_1_plus, x)+2*diff(phi,x)**2*QKdV_3_plus))
print('--------------------------------------------------------------------------')
print(showDiffNotation(expand(2*QKdV_2_plus-diff(phi, x)**2*diff(QKdV_1_plus, x)+2*diff(phi,x)**2*QKdV_3_plus)))
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
print('diff(QKdV_2_plus,t)-diff(phi,x)**4*QKdV_5_plus = ')
print('--------------------------------------------------------------------------')
...
u3_Q3_extractor_together = expand((2*QKdV_2_plus-diff(phi, x)**2*diff(QKdV_1_plus, x)+2*diff(phi,x)**2*QKdV_3_plus)*(- sigma*Derivative(phi, x)**2*Derivative(phi, t, (x, 4)) + 4*sigma*Derivative(phi, x)*Derivative(phi, (x, 2))*Derivative(phi, t, (x, 3)) + 4*sigma*Derivative(phi, x)*Derivative(phi, (x, 3))*Derivative(phi, t, (x, 2)) - 2*sigma*Derivative(phi, x)*Derivative(phi, (x, 4))*Derivative(phi, t, x) - 9*sigma*Derivative(phi, (x, 2))**2*Derivative(phi, t, (x, 2)) + 4*sigma*Derivative(phi, (x, 2))*Derivative(phi, (x, 3))*Derivative(phi, t, x) - u3**2*Derivative(phi, x)**5 - u3*Derivative(phi, x)**4*Derivative(u2, x) + 4*u3*Derivative(phi, x)**3*Derivative(phi, t, x) + Derivative(phi, t)*Derivative(phi, x)*Derivative(phi, t, (x, 2)) + Derivative(phi, t)*Derivative(phi, (x, 2))*Derivative(phi, t, x) + Derivative(phi, (t, 2))*Derivative(phi, x)*Derivative(phi, (x, 2)) - Derivative(phi, x)**2*Derivative(phi, (t, 2), x) - 2*Derivative(phi, x)*Derivative(phi, t, x)**2) - \
 														(diff(QKdV_2_plus,t)-diff(phi,x)**4*QKdV_5_plus)*(-4*sigma*Derivative(phi, x)**3*Derivative(phi, (x, 4)) + 2*sigma*Derivative(phi, x)**2*Derivative(phi, (x, 2))*Derivative(phi, (x, 3)) + 8*sigma*Derivative(phi, x)*Derivative(phi, (x, 2))*Derivative(phi, (x, 3)) - 6*sigma*Derivative(phi, (x, 2))**3 - 2*u2*Derivative(phi, x)**3*Derivative(phi, (x, 2)) + 2*u2*Derivative(phi, x)**2*Derivative(phi, (x, 2)) - Derivative(phi, t)*Derivative(phi, x)**2*Derivative(phi, (x, 2)) + 2*Derivative(phi, t)*Derivative(phi, x)*Derivative(phi, (x, 2)) - Derivative(phi, x)**4*Derivative(u2, x) - Derivative(phi, x)**3*Derivative(phi, t, x)))
u3_Q3_extractor_together = expand(u3_Q3_extractor_together)
H3 = expand(- sigma*Derivative(phi, x)**2*Derivative(phi, t, (x, 4)) + 4*sigma*Derivative(phi, x)*Derivative(phi, (x, 2))*Derivative(phi, t, (x, 3)) + 4*sigma*Derivative(phi, x)*Derivative(phi, (x, 3))*Derivative(phi, t, (x, 2)) - 2*sigma*Derivative(phi, x)*Derivative(phi, (x, 4))*Derivative(phi, t, x) - 9*sigma*Derivative(phi, (x, 2))**2*Derivative(phi, t, (x, 2)) + 4*sigma*Derivative(phi, (x, 2))*Derivative(phi, (x, 3))*Derivative(phi, t, x) - u3**2*Derivative(phi, x)**5 - u3*Derivative(phi, x)**4*Derivative(u2, x) + 4*u3*Derivative(phi, x)**3*Derivative(phi, t, x) + Derivative(phi, t)*Derivative(phi, x)*Derivative(phi, t, (x, 2)) + Derivative(phi, t)*Derivative(phi, (x, 2))*Derivative(phi, t, x) + Derivative(phi, (t, 2))*Derivative(phi, x)*Derivative(phi, (x, 2)) - Derivative(phi, x)**2*Derivative(phi, (t, 2), x) - 2*Derivative(phi, x)*Derivative(phi, t, x)**2)
H4 = expand(-4*sigma*Derivative(phi, x)**3*Derivative(phi, (x, 4)) + 2*sigma*Derivative(phi, x)**2*Derivative(phi, (x, 2))*Derivative(phi, (x, 3)) + 8*sigma*Derivative(phi, x)*Derivative(phi, (x, 2))*Derivative(phi, (x, 3)) - 6*sigma*Derivative(phi, (x, 2))**3 - 2*u2*Derivative(phi, x)**3*Derivative(phi, (x, 2)) + 2*u2*Derivative(phi, x)**2*Derivative(phi, (x, 2)) - Derivative(phi, t)*Derivative(phi, x)**2*Derivative(phi, (x, 2)) + 2*Derivative(phi, t)*Derivative(phi, x)*Derivative(phi, (x, 2)) - Derivative(phi, x)**4*Derivative(u2, x) - Derivative(phi, x)**3*Derivative(phi, t, x))
print('--------------------------------------------------------------------------')
print('H3 = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(H3))
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
print('H4 = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(H4))
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
print('u3_Q3_extractor_together = ')
print('--------------------------------------------------------------------------')
print(u3_Q3_extractor_together)
print('--------------------------------------------------------------------------')
print('coeff(u3x_extractor, diff(u3,(x,3))) = ', showDiffNotation(u3_Q3_extractor_together.coeff(diff(u3,(x,3)), 1)))
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
print('coeff(u3x_extractor, diff(u3,(x,2))) = ', showDiffNotation(u3_Q3_extractor_together.coeff(diff(u3,(x,2)), 1)))
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
print('coeff(u3x_extractor, diff(u3,x)) = ', showDiffNotation(u3_Q3_extractor_together.coeff(diff(u3,x), 1)))
print('--------------------------------------------------------------------------')
...
diffQKdV_2_plus_x = expand(diff(QKdV_2_plus, x))
print('--------------------------------------------------------------------------')
print('diffQKdV_2_plus_x = diff(QKdV_2_plus, x) = ')
print('--------------------------------------------------------------------------')
print(diffQKdV_2_plus_x)
print('--------------------------------------------------------------------------')

coeff_of_QKdV_6_plus_diffQKdV_2_plus_x = diffQKdV_2_plus_x.coeff(diff(u3,x), 1)
print('--------------------------------------------------------------------------')
print('coeff_of_QKdV_6_plus_diffQKdV_2_plus_x = ')
print('--------------------------------------------------------------------------')
print(coeff_of_QKdV_6_plus_diffQKdV_2_plus_x)
print('--------------------------------------------------------------------------')

extraction_diffQKdV_2_plus_x_from_QKdV_6_plus = diffQKdV_2_plus_x - coeff_of_QKdV_6_plus_diffQKdV_2_plus_x*diff(u3,x)
print('--------------------------------------------------------------------------')
print('extraction_diffQKdV_2_plus_x_from_QKdV_6_plus = ')
print('--------------------------------------------------------------------------')
print(extraction_diffQKdV_2_plus_x_from_QKdV_6_plus)
print('--------------------------------------------------------------------------')
...
# diffQKdV_2_plus_xx = expand(diff(QKdV_2_plus, x, x))
# print('--------------------------------------------------------------------------')
# print('diffQKdV_2_plus_xx = diff(QKdV_2_plus, x, x) = ')
# print('--------------------------------------------------------------------------')
# print(diffQKdV_2_plus_xx)
# print('--------------------------------------------------------------------------')

# coeff_of_QKdV_6_plus_diffQKdV_2_plus_x = diffQKdV_2_plus_xx.coeff(diff(u3,x), 1)
# print('--------------------------------------------------------------------------')
# print('coeff_of_QKdV_6_plus_diffQKdV_2_plus_x = ')
# print('--------------------------------------------------------------------------')
# print(coeff_of_QKdV_6_plus_diffQKdV_2_plus_x)
...
# coeff_of_diff_QKdV_6_plus_x_diffQKdV_2_plus_xx = diffQKdV_2_plus_xx.coeff(diff(u3,x,x), 1)
# print('--------------------------------------------------------------------------')
# print('coeff_of_diff_QKdV_6_plus_x_diffQKdV_2_plus_xx = ')
# print('--------------------------------------------------------------------------')
# print(coeff_of_diff_QKdV_6_plus_x_diffQKdV_2_plus_xx)
# print('--------------------------------------------------------------------------')

# extraction_diffQKdV_2_plus_x_from_QKdV_6_plus = diffQKdV_2_plus_x - coeff_of_diff_QKdV_6_plus_x_diffQKdV_2_plus_xx*diff(u3,x,x)
# print('--------------------------------------------------------------------------')
# print('extraction_diffQKdV_2_plus_x_from_QKdV_6_plus = ')
# print('--------------------------------------------------------------------------')
# print(extraction_diffQKdV_2_plus_x_from_QKdV_6_plus)
