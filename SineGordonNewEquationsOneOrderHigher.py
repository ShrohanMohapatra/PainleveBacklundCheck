...
u3_solution = solve(Equation3, u3)[0]
u3_solution = together(u3_solution).doit()
Equation3_residual = Equation3.subs(u3, u3_solution)
Equation3_residual, _ = fraction(together(Equation3_residual).doit())
Equation3_residual = expand(Equation3_residual)
print('--------------------------------------------------------------------------')
print('Equation for 3rd power coefficient')
print('--------------------------------------------------------------------------')
print('u3 = ', showDiffNotation(u3_solution))
print('--------------------------------------------------------------------------')
print('Equation3_residual = ', Equation3_residual)
print('--------------------------------------------------------------------------')

Equation4 = simplify(TransformedSineGordonPainleveExpansion_polyInTermsOfPhi.coeff(1/phi, 2))
print('--------------------------------------------------------------------------')
print('Equation for 4th power coefficient without substitution')
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
...
Equation4 = expand(Equation4.subs(u3, u3_solution).doit())
...
print('--------------------------------------------------------------------------')
print('Equation for 5th power coefficient without substitution')
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
...
Equation5 = expand(Equation5.subs(u3, u3_solution).doit())
...
Equation6 = simplify(TransformedSineGordonPainleveExpansion_polyInTermsOfPhi.coeff(phi, 0))
print('--------------------------------------------------------------------------')
print('Equation for 6th power coefficient without substitution')
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
...
Equation6 = expand(Equation6.subs(u3, u3_solution).doit())
...
Equation7 = simplify(TransformedSineGordonPainleveExpansion_polyInTermsOfPhi.coeff(phi, 1))
print('--------------------------------------------------------------------------')
print('Equation for 7th power coefficient without substitution')
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
...
Equation7 = expand(Equation7.subs(u3, u3_solution).doit())
...
Equation8 = simplify(TransformedSineGordonPainleveExpansion_polyInTermsOfPhi.coeff(phi, 2))
print('--------------------------------------------------------------------------')
print('Equation for 8th power coefficient without substitution')
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
print(showDiffNotation(Equation8),' = 0')
print('--------------------------------------------------------------------------')
Equation8 = expand(Equation8.subs(u0, u0_solution).doit())
Equation8 = expand(Equation8.subs(u1, u1_solution).doit())
Equation8 = expand(Equation8.subs(u3, u3_solution).doit())
Equation8, _ = fraction(together(Equation8.doit()))
Equation8 = expand(Equation8)
print('--------------------------------------------------------------------------')
print('Equation for 8th power coefficient')
print('--------------------------------------------------------------------------')
# print('--------------------------------------------------------------------------')
# print(Equation8,' = 0')
# print('--------------------------------------------------------------------------')
...
Equation9 = simplify(TransformedSineGordonPainleveExpansion_polyInTermsOfPhi.coeff(phi, 3))
print('--------------------------------------------------------------------------')
print('Equation for 9th power coefficient without substitution')
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
print(showDiffNotation(Equation9),' = 0')
print('--------------------------------------------------------------------------')
Equation9 = expand(Equation9.subs(u0, u0_solution).doit())
Equation9 = expand(Equation9.subs(u1, u1_solution).doit())
Equation9 = expand(Equation9.subs(u3, u3_solution).doit())
Equation9, _ = fraction(together(Equation9.doit()))
Equation9 = expand(Equation9)
print('--------------------------------------------------------------------------')
print('Equation for 9th power coefficient')
print('--------------------------------------------------------------------------')
# print('--------------------------------------------------------------------------')
# print(Equation9,' = 0')
# print('--------------------------------------------------------------------------')
...
Equation10 = simplify(TransformedSineGordonPainleveExpansion_polyInTermsOfPhi.coeff(phi, 4))
print('--------------------------------------------------------------------------')
print('Equation for 10th power coefficient without substitution')
print('--------------------------------------------------------------------------')
print('--------------------------------------------------------------------------')
print(showDiffNotation(Equation10),' = 0')
print('--------------------------------------------------------------------------')
Equation10 = expand(Equation10.subs(u0, u0_solution).doit())
Equation10 = expand(Equation10.subs(u1, u1_solution).doit())
Equation10 = expand(Equation10.subs(u3, u3_solution).doit())
Equation10, _ = fraction(together(Equation10.doit()))
Equation10 = expand(Equation10)
print('--------------------------------------------------------------------------')
print('Equation for 10th power coefficient')
print('--------------------------------------------------------------------------')
# print('--------------------------------------------------------------------------')
# print(Equation10,' = 0')
# print('--------------------------------------------------------------------------')
