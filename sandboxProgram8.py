...
KdV_Burgers_Equation = parse_expr('diff(f(x,t),t)+f(x,t)*diff(f(x,t),x)-sigma*diff(f(x,t),(x,2))+kappa*diff(f(x,t),(x,3))')
result_package = ultimatePainleve(KdV_Burgers_Equation, x, t)
print('------------------------------------------------------------------')
