...
print('--------------------------------------------------------------------------')
print(showDiffNotation(expand(Equation3_compatibility_test)), '= 0')
print('--------------------------------------------------------------------------')
...
print('--------------------------------------------------------------------------')
print(showDiffNotation(expand(Equation4_compatibility_test)), '= 0')
print('--------------------------------------------------------------------------')

# print(
# 	CompatibilitySystemPDEs([
# 		expand((Equation2Storage)/(24*sigma*diff(phi,x))),
# 		expand((Equation3_compatibility_test)/(12*sigma)),
# 		expand((Equation4_compatibility_test)/(12*sigma))
# 		], phi)
# )

# Equation2Storage = expand((Equation2Storage)/(24*sigma*diff(phi,x)))
# Equation3_compatibility_test = expand((Equation3_compatibility_test)/(12*sigma))
# Equation4_compatibility_test = expand((Equation4_compatibility_test)/(12*sigma))

solution_to_phi_t = expand(solve(Equation2Storage, diff(phi, t))[0])
print('--------------------------------------------------------------------------')
print('phi_t =')
print('--------------------------------------------------------------------------')
print(showDiffNotation(solution_to_phi_t))
print('--------------------------------------------------------------------------')

solution_to_phi_xt = expand(diff(solution_to_phi_t, x))
print('--------------------------------------------------------------------------')
print('phi_xt =')
print('--------------------------------------------------------------------------')
...
solution_to_phi_x4 = expand(solve(Equation3_compatibility_test, diff(phi, (x, 4)))[0])
print('--------------------------------------------------------------------------')
print('phi_x4 =')
print('--------------------------------------------------------------------------')
...
solution_dictionary = solve(
    [
        diff(phi, t) - solution_to_phi_t,
        diff(phi, x, t) - solution_to_phi_xt,
...
solution_to_phi_t = expand(solution_dictionary[diff(phi, t)])
...
solution_to_u1_t = expand(solve(Equation4_compatibility_test, diff(u1, t))[0])
print('--------------------------------------------------------------------------')
print('u1_t =')
print('--------------------------------------------------------------------------')
print(showDiffNotation(solution_to_u1_t))
print('--------------------------------------------------------------------------')

solution_to_u1_xt = expand(diff(solution_to_u1_t, x).doit())
print('--------------------------------------------------------------------------')
print('u1_xt =')
print('--------------------------------------------------------------------------')
print(showDiffNotation(solution_to_u1_xt))
print('--------------------------------------------------------------------------')
...
solution_to_phi_xxxxt_part1 = expand(solution_to_phi_xxxxt_part1.subs(diff(phi,(x,4)), solution_to_phi_x4).doit())
print('--------------------------------------------------------------------------')
print('phi_xxxxt_part1 =')
print('--------------------------------------------------------------------------')
print(showDiffNotation(solution_to_phi_xxxxt_part1))
print('--------------------------------------------------------------------------')

solution_to_phi_xxxxt_part2 = expand(diff(solution_to_phi_x4, t).doit())
solution_to_phi_xxxxt_part2 = expand(solution_to_phi_xxxxt_part2.subs(diff(phi,(x,3),t), solution_to_phi_xxxt).doit())
solution_to_phi_xxxxt_part2 = expand(solution_to_phi_xxxxt_part2.subs(diff(phi,(x,2),t), solution_to_phi_xxt).doit())
solution_to_phi_xxxxt_part2 = expand(solution_to_phi_xxxxt_part2.subs(diff(phi,x,t), solution_to_phi_xt).doit())
solution_to_phi_xxxxt_part2 = expand(solution_to_phi_xxxxt_part2.subs(diff(u1,t), solution_to_u1_t).doit())
solution_to_phi_xxxxt_part2 = expand(solution_to_phi_xxxxt_part2.subs(diff(u1,x,t), solution_to_u1_xt).doit())
print('--------------------------------------------------------------------------')
print('phi_xxxxt_part2 =')
print('--------------------------------------------------------------------------')
print(showDiffNotation(solution_to_phi_xxxxt_part2))
print('--------------------------------------------------------------------------')

compatibility_test = expand(solution_to_phi_xxxxt_part1-solution_to_phi_xxxxt_part2).doit()
print('--------------------------------------------------------------------------')
print('phi_xxxxt_part1 - phi_xxxxt_part2 =')
print('--------------------------------------------------------------------------')
print(showDiffNotation(compatibility_test))
print('--------------------------------------------------------------------------')

compatibility_test = expand(compatibility_test.subs(u1, 12*sigma*diff(phi,x,x)).doit()).doit()
print('--------------------------------------------------------------------------')
print('Also with the help of u1 = 12 sigma phi_xx, phi_xxxxt_part1 - phi_xxxxt_part2 =')
print('--------------------------------------------------------------------------')
print(showDiffNotation(compatibility_test))
print('--------------------------------------------------------------------------')
