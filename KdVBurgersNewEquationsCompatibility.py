...
print('--------------------------------------------------------------------------')
print('Equation number 2')
print('--------------------------------------------------------------------------')
print_latex(showDiffNotation(Equation2))
print(' = 0')
print('--------------------------------------------------------------------------')
...
print('--------------------------------------------------------------------------')
print_latex(showDiffNotation(Equation3_compatibility_test))
print(' = 0')
print('--------------------------------------------------------------------------')
...
print('--------------------------------------------------------------------------')
print_latex(showDiffNotation(Equation5_compatibility_test))
print(' = 0')
print('--------------------------------------------------------------------------')
...
print('\\phi_t =')
print('--------------------------------------------------------------------------')
print_latex(dictionary_of_solutions[diff(phi, t)])
print('--------------------------------------------------------------------------')
...
print('\\phi_xt =')
print('--------------------------------------------------------------------------')
print_latex(dictionary_of_solutions[diff(phi, x, t)])
print('--------------------------------------------------------------------------')

print('--------------------------------------------------------------------------')
print('\\phi_xxxx =')
print('--------------------------------------------------------------------------')
print_latex(dictionary_of_solutions[diff(phi, (x, 4))])
print('--------------------------------------------------------------------------')

print('--------------------------------------------------------------------------')
print('\\u_{2, t} =')
print('--------------------------------------------------------------------------')
print_latex(dictionary_of_solutions[diff(u2, t)])
print('--------------------------------------------------------------------------')
...
for term in dictionary_of_solutions:
	print('--------------------------------')
	print(term,':')
	print_latex(dictionary_of_solutions[term])
	print('--------------------------------')
...
print('--------------------------------')
print_latex(compatibility_test)
print(' = 0')
print('--------------------------------')

compatibility_test = expand(compatibility_test.subs(sigma, 0))
print('--------------------------------')
print('Compatibility test for sigma = 0, equation2 - equation1 =')
print('--------------------------------')
