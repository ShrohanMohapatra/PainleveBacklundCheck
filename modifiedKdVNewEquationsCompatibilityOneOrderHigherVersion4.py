...
Equation3_compatibility_test = expand(Equation3_compatibility_test.subs(u2, 0).doit())
print('--------------------------------------------------------------------------')
...
Equation4_compatibility_test = expand(Equation4_compatibility_test.subs(u2, 0).doit())
print('--------------------------------------------------------------------------')
...
Equation5_compatibility_test = expand(Equation5_compatibility_test.subs(u2, 0).doit())
print('--------------------------------------------------------------------------')
...
Equation6_compatibility_test = expand(Equation6_compatibility_test.subs(u2, 0).doit())
print('--------------------------------------------------------------------------')
