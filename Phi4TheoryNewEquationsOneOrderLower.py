...
def CompatibilitySystemPDEs(systemsOfPDEs, func, depth_max = 150, depth = 0):
	...
	if len(systemsOfPDEs) == 2:
		...
		for k in range(len(systemsOfPDEs_F)):
			...
			print('---------------------------------------------------')
			if len(Add.make_args(systemsOfPDEs_F[k])) > 550: return [depth, False]
...
print(showDiffNotation(Phi4TheoryPainleveExpansion_polyInTermsOfPhi))
...
Equation3Storage = Equation3
Equation3 = expand(Equation3)
factors_list_of_equation3 = factor_list(Equation3)
print('--------------------------------------------------------------------------')
print('Equation for 3rd power coefficient')
print('--------------------------------------------------------------------------')
print(showDiffNotation(Equation3Storage),' = 0')
print('--------------------------------------------------------------------------')

# Equation4 = expand(Phi4TheoryPainleveExpansion_polyInTermsOfPhi.coeff(phi, 1))
# Equation4Storage = Equation4
# Equation4Storage = expand(Equation4Storage)
# factors_list_of_equation4 = factor_list(Equation4Storage)
# print('--------------------------------------------------------------------------')
# print('Equation for 4th power coefficient')
# print('--------------------------------------------------------------------------')
# print(showDiffNotation(Equation4Storage),' = 0')
# print('--------------------------------------------------------------------------')

# Equation5 = expand(Phi4TheoryPainleveExpansion_polyInTermsOfPhi.coeff(phi, 2))
# Equation5Storage = Equation5
# Equation5Storage = expand(Equation5Storage)
# factors_list_of_equation5 = factor_list(Equation5Storage)
# print('--------------------------------------------------------------------------')
# print('Equation for 5th power coefficient')
# print('--------------------------------------------------------------------------')
# print(showDiffNotation(Equation5Storage),' = 0')
# print('--------------------------------------------------------------------------')

# Equation6 = expand(Phi4TheoryPainleveExpansion_polyInTermsOfPhi.coeff(phi, 3))
# Equation6Storage = Equation6
# Equation6Storage = expand(Equation6Storage)
# factors_list_of_equation6 = factor_list(Equation6Storage)
# print('--------------------------------------------------------------------------')
# print('Equation for 6th power coefficient')
# print('--------------------------------------------------------------------------')
# print(showDiffNotation(Equation6Storage),' = 0')
# print('--------------------------------------------------------------------------')
...
phi_tt_solution = expand(solve(Equation1Storage, diff(phi,t,t))[-1])
...
phi_xx_solution = expand(diff(phi_x_solution,x))
print('--------------------------------------------------------------------------')
...
phi_xt_solution = expand(diff(phi_x_solution,t))
print('--------------------------------------------------------------------------')
...
u0_tt_solution = expand(solve(Equation2Storage, diff(u0,t,t))[-1])
print('--------------------------------------------------------------------------')
...
solution_to_all_phi_derivatives = solve(
									[
										diff(phi,x)-phi_x_solution,
										diff(phi,t,t)-phi_tt_solution,
										diff(phi,x,t)-phi_xt_solution,
										diff(phi,x,x)-phi_xx_solution
									],
									[diff(phi,x),diff(phi,t,t),diff(phi,x,t),diff(phi,x,x)]
									)

phi_x_new_solution = expand(solution_to_all_phi_derivatives[diff(phi, x)])
phi_tt_new_solution = expand(solution_to_all_phi_derivatives[diff(phi, t, t)])
phi_xt_new_solution = expand(solution_to_all_phi_derivatives[diff(phi, x, t)])
phi_xx_new_solution = expand(solution_to_all_phi_derivatives[diff(phi, x, x)])

print('--------------------------------------------------------------------------')
print('phi_x_new_solution = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(phi_x_new_solution))
print('--------------------------------------------------------------------------')

print('--------------------------------------------------------------------------')
print('phi_tt_new_solution = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(phi_tt_new_solution))
print('--------------------------------------------------------------------------')

print('--------------------------------------------------------------------------')
print('phi_xt_new_solution = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(phi_xt_new_solution))
print('--------------------------------------------------------------------------')

print('--------------------------------------------------------------------------')
print('phi_xx_new_solution = ')
print('--------------------------------------------------------------------------')
print(showDiffNotation(phi_xx_new_solution))
print('--------------------------------------------------------------------------')

dictionary_of_solutions = {}
dictionary_of_solutions[diff(phi, x)] = phi_x_new_solution
dictionary_of_solutions[diff(phi, t, t)] = phi_tt_new_solution
dictionary_of_solutions[diff(phi, x, t)] = phi_xt_new_solution
dictionary_of_solutions[diff(phi, x, x)] = phi_xx_new_solution
...
for term in dictionary_of_solutions:
	phi_xxt_solution_1 = phi_xxt_solution_1.subs(term, dictionary_of_solutions[term]).doit()
	phi_xxt_solution_1 = expand(phi_xxt_solution_1)
print('--------------------------------------------------------------------------')
